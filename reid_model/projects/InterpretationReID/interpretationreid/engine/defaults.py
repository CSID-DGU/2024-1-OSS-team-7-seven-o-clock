...
from projects.InterpretationReID.interpretationreid.evaluation import (DatasetEvaluator, ReidEvaluator,
                                 inference_on_dataset, print_csv_format)
from fastreid.modeling.meta_arch import build_model
from fastreid.solver import build_lr_scheduler, build_optimizer
from fastreid.utils import comm
from projects.InterpretationReID.interpretationreid.utils.checkpoint import Checkpointer
...
class DefaultTrainer(SimpleTrainer):
    ...
    def load_n_or_not(self):
        """
        Load the model parameters of the first N layers
        :return: None
        """
        #TODO CXD
        #print(self.cfg.INTERPRETATION.PRETRAIN_MODEL)
        self.checkpointer.load_n(self.cfg.INTERPRETATION.PRETRAIN_MODEL,self.cfg)
    ...
    def build_hooks(self):
        ...
        if cfg.MODEL.FREEZE_LAYERS != [''] and cfg.SOLVER.FREEZE_ITERS > 0:
            ...
            ret.append(hooks.FreezeLayer(
                ...
                cfg.INTERPRETATION.FREEZE_LAYERS
            ))
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TESTS):
            ...
            if evaluators is not None:
                ...
                try:
                    ...
                    continue
            results_i = inference_on_dataset(model, data_loader, evaluator,name_of_attribute)
